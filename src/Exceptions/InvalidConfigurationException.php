...
class InvalidConfigurationException extends FawryException
{
    ...
    {
        return new self(__('fawry.exceptions.configuration.missing_merchant_code'));
    }

    public static function missingSecureKey(): self
    {
        return new self(__('fawry.exceptions.configuration.missing_secure_key'));
    }

    public static function missingBaseUrl(): self
    {
        return new self(__('fawry.exceptions.configuration.missing_base_url'));
    }
} 