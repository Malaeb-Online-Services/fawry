...
class PaymentException extends FawryException
{
    ...
    {
        return new self(Lang::get('fawry::exceptions.payment.invalid_items'));
    }

    public static function invalidAmount(): self
    {
        return new self(Lang::get('fawry::exceptions.payment.invalid_amount'));
    }

    public static function invalidCustomerData(): self
    {
        return new self(Lang::get('fawry::exceptions.payment.invalid_customer_data'));
    }
